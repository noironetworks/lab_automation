...
--name fab205-compute00 \
--profile rhel9_4-x86_64 \
--netboot-enabled=true \
--autoinstall compute-ks.cfg \
--hostname compute00 \
--dns-name compute00.fab205.local \
...
--gateway 1.100.1.1 \
--kernel-options="ip=eno1:dhcp:1500 ip=10.100.1.100::10.100.1.1:255.255.255.0:compute00.fab205.local:ens9f0.4001:none:9000 vlan=ens9f0.4001:ens9f0"

...
export CONFIG=$HOME/openstack_automation_scripts/install_openstack/bionic-ussuri/ussuri-opflex-sfc.yaml
...
juju deploy  --config=$CONFIG nova-compute --channel ussuri/candidate --series bionic --to "$compute01_id"

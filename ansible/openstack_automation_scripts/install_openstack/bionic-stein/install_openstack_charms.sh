...
export CONFIG=$HOME/openstack_automation_scripts/install_openstack/bionic-stein/stein-opflex-sfc.yaml
...
juju deploy  --config=$CONFIG nova-compute --channel stein/candidate --series bionic --to "$compute01_id"
